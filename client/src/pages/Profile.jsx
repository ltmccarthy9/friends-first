...
const Profile = () => {
    ...
    return (
         <div className="flex mt-14 mx-auto h-screen bg-slate-100 dark:bg-gray-600">
            <div className="flex flex-col w-full justify-center sm:flex-row p-4">
                ...
                <h2 className="theme-dark tracking-tight text-xl font-bold px-1 pt-2 pb-1">{username}'s</h2>
                    ...
                    className={past ? "text-left font-semibold px-1 py-2 tracking-tight text-lg cursor-pointer profile-active border-l-2 border-teal-500 bg-teal-200" 
                    : "text-left tracking-tight text-lg cursor-pointer px-1 py-2 hover:bg-gray-100 hover:rounded-lg "}>Past Events</button>
                </div>
