  ...
  return (
    <div className="flex mt-14 mx-auto w-full h-screen bg-slate-100 dark:bg-gray-600">
        <div className="flex flex-col w-full justify-center sm:flex-row p-4">
            <div className="mt-8 flex flex-col rounded-md bg-[#fbfcfc] mr-4 pt-2 h-fit w-full sm:w-48 sm:mx-8 bg-gray-50 text-gray-700 dark:bg-gray-700 dark:text-gray-50">
                ...
                className={past ? "text-left font-semibold px-1 py-2 tracking-tight rounded-bl-md rounded-br-lg text-lg cursor-pointer border-l-4 border-teal-500 bg-gray-200 dark:bg-gray-500" 
