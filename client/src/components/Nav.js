...
const Nav = () => {
  ...
  return (
      <div className="theme-green nav-bar h-fit flex justify-center bg-slate-100 z-10">
        <h1 onClick={goDashboard} className="my-auto font-extrabold tracking-tight text-3xl mr-32 cursor-pointer" >Friends First.</h1>
        
        <div className={dashboard ? 'border-b-2 border-slate-700 mx-2 p-4' : 'mx-2 p-4'}>
        ...
        <div className={profile ? 'border-b-2 border-slate-700 mx-2 p-4' : 'mx-2 p-4'}>
